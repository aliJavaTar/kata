...
public class NthDigit {
    ...
    public static int nthDigit(int n) {
        ...
        int start = 1;         // Starting number for the current digit length
        ...
        // Step 2: Identify the actual number where the nth digit falls
        start += (n - 1) / digitLength;

        // Step 3: Find the specific digit within the identified number
